...
export default function Home() {
  ...
  return (
    <main className="h-screen w-full bg-background text-foreground flex flex-col relative overflow-hidden">
      ...
      <div className="flex-1 flex flex-col relative z-10 pt-16 pb-36 px-4 max-w-5xl mx-auto w-full overflow-hidden">
      ...
      <div className="fixed bottom-2 left-0 right-0 z-30 flex justify-center pointer-events-none">
