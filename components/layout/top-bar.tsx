...
export function TopBar() {
  ...
  return (
    <div className="fixed top-0 left-0 right-0 h-16 flex items-start justify-center z-40 bg-gradient-to-b from-background to-transparent pointer-events-none pt-4">
      <div className="pointer-events-auto bg-background/50 backdrop-blur-md border border-border/50 rounded-full px-4 md:px-6 py-2 shadow-sm flex items-center gap-2 md:gap-4 transition-all hover:bg-background/80 hover:shadow-md h-10">
        <Label className="hidden md:block text-xs text-muted-foreground font-mono uppercase tracking-wider whitespace-nowrap">
          {config.label}
        </Label>
